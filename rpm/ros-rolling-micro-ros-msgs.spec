...
Name:           ros-rolling-micro-ros-msgs
Version:        1.0.0
Release:        3%{?dist}%{?release_suffix}
Summary:        ROS micro_ros_msgs package
...
%description
Definitions for the ROS 2 msgs entities information used by micro-ROS to
leverage its functionality to the same level as ROS 2, by means of a dedicated
graph manager
...
%changelog
* Tue Jun 20 2023 Jose Antonio Moral <josesantoniomoralparras@eprosima.com> - 1.0.0-3
